...
const EMAIL_FROM = process.env.EMAIL_FROM ?? "Kumo <noreply@kumo.com>"
...
export async function sendWelcomeEmail(to: string, academyName: string) {
  return sendEmail({
    to,
    subject: `Welcome to ${academyName} on Kumo`,
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        <h2>Welcome to ${academyName}!</h2>
        <p>Your academy is set up and ready to go on Kumo.</p>
        ...
        <p style="color:#888;font-size:13px;">— The Kumo Team</p>
      </div>
    `,
  })
}
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        ...
        <p style="color:#888;font-size:13px;">— Kumo</p>
      </div>
    `,
  })
}
...
export async function sendInviteEmail(
  ...
  return sendEmail({
    to,
    subject: `You've been invited to join ${academyName} on Kumo`,
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        <h2>You've been invited!</h2>
        <p><strong>${academyName}</strong> has invited you to join their academy on Kumo as an instructor.</p>
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        ...
        <p style="color:#888;font-size:13px;">— ${opts.academyName} via Kumo</p>
      </div>
    `,
  })
}
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        ...
        <p>Keep training hard and see your progress on Kumo:</p>
        <p>
