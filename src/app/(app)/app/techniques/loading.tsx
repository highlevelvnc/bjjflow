      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="rounded-xl border border-white/8 bg-gray-900 p-5">
            ...
            <div className="mt-2 h-3 w-20 animate-pulse rounded-md bg-gray-800" />
            <div className="mt-3 space-y-1.5">
              <div className="h-3 w-full animate-pulse rounded-md bg-gray-800" />
              <div className="h-3 w-4/5 animate-pulse rounded-md bg-gray-800" />
            </div>
          </div>
        ))}
      </div>
